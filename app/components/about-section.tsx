        ...
        <div className="grid md:grid-cols-12 gap-10 md:gap-16 items-start">
          ...
          <div className="md:col-span-5 relative">
            <div className="relative overflow-hidden rounded-3xl aspect-[3/4] shadow-2xl shadow-brand-terracotta/8">
              <div
                ref={photoRef}
                className="absolute inset-[-20%] bg-gradient-to-br from-brand-terracotta/25 via-brand-sand to-brand-coral/20"
              />
