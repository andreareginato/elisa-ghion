...
export default function EditResearchArea({ loaderData }: Route.ComponentProps) {
  ...
  const influences = (researchArea.influences || []) as string[];
  const relatedWorkshops = (researchArea.relatedWorkshops || []) as Array<{
    id: string;
    title: string;
  }>;
  const selectedWorkshopIds = new Set(relatedWorkshops.map((w) => w.id));

  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold text-gray-900 mb-8">Edit Research Area</h1>
      ...
      <form method="post" className="bg-white rounded-xl border border-gray-200 p-6 space-y-6">
        <div>
          ...
          <input
            ...
            name="title"
            required
            defaultValue={researchArea.title}
        ...
        <div>
          ...
          <input
            ...
            name="question"
            required
            defaultValue={researchArea.question}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-terracotta"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={6}
            required
            defaultValue={researchArea.description}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-terracotta"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            name="quote"
            rows={3}
            defaultValue={researchArea.quote}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-terracotta"
          />
        </div>
            ...
            {workshops.map((workshop) => (
              <div key={workshop.id} className="flex items-center">
                <input
                  ...
                  value={workshop.id}
                  defaultChecked={selectedWorkshopIds.has(workshop.id)}
        ...
        <div>
          ...
          <input
            ...
            id="image"
            name="image"
            defaultValue={researchArea.image}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-terracotta"
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            name="sortOrder"
            required
            defaultValue={researchArea.sortOrder}
            className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-terracotta"
          />
        </div>
